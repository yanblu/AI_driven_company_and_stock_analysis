...
Every collected artifact should append a row here so that README_data.md can
summarize sources, retrieval dates, and SHA-256 checksums as required by the
guideline's 'clearly document your data sources' deliverable.
"""
...
MANIFEST_COLUMNS = [
    "source",            # high-level source name (e.g., yfinance, sec_edgar)
    "artifact_type",     # prices|macro|filing|transcript|news|chunks|llm_annotations
